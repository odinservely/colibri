...
describe('Service Tests', () => {
    describe('Association Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AssociationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/associations';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Association', () => {
                service.create(new Association(null)).subscribe(received => {
            ...
            it('should update a Association', () => {
                service.update(new Association(123)).subscribe(received => {
            ...
            it('should return a Association', () => {
